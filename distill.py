"""
python distill.py -t --base configs/stable-diffusion/pokemon_distill.yaml --gpus 0,1 --scale_lr False --num_nodes 1 --check_val_every_n_epoch 1 
--finetune_from /nvme/caoweihan.p/pokemon_1024/2023-05-26T10-37-32_pokemon/checkpoints/epoch=000179.ckpt
"""
...
class ImageLogger(Callback):
    def __init__(self, batch_frequency, max_images, clamp=True, increase_log_steps=True,
                 ...
                 log_images_kwargs=None, log_all_val=False, epoch_freq=10):
        super().__init__()
        self.rescale = rescale
        # self.batch_freq = 1#batch_frequency
    ...
    def log_img(self, pl_module, batch, batch_idx, cur_epoch, split="train"):
        ...
        if (should_log and  (cur_epoch % self.epoch_freq == 0) and
    ...
    def on_validation_batch_end(self, trainer, pl_module, outputs, batch, batch_idx, dataloader_idx):
        ...
        if not self.disabled and pl_module.global_step > 0:
            self.log_img(pl_module, batch, batch_idx, split="val", cur_epoch=trainer.fit_loop.current_epoch)
    ...
    try:
        ...
        if not opt.finetune_from == "":
            ...
            for key in ckpt.keys():
                ...
                if ckpt[key].shape != old_state[key].shape:
                    remove.append(key)
            for r in remove:
                old_state.pop(r)
                print(f'pop key {r}')
